<template>
    <div class="pro-item">
        ...
        <div class="pro-top" :class="(isMain && ![1,3].includes(data.activity_id)) ?'':'noBorder'" @click="openDetails(data)">
            <div class="left-img">
    ...
    methods: {
        openDetails(data) {
            ...
            if(this.isMain && data.activity_id != 0){
                location.href = './sourceShopDetails.html?id='+data.goods_id + '&local='+local+'&isBuyPresent=true&activity_id=' + data.activity_id;
            }else{
