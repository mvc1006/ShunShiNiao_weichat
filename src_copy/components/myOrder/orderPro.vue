...
<div class="mian-goods">
    ...
    <ul class="order-time-list" v-if="isDetails">
       <li class="orter-time-item"><span class="name">商品组编号</span><span class="numer">{{data.union_order_no}}</span></li>
       <li class="orter-time-item"><span class="name">订单编号</span><span class="numer">{{data.order_no}}</span></li>
       <li class="orter-time-item"><span class="name">创建时间</span><span class="numer">{{data.create_time}}</span></li>
       <template v-if="data.order_status >= 2 && !data.give_list">
            <li class="orter-time-item"><span class="name">付款时间</span><span class="numer">{{data.pay_time}}</span></li>
       </template>
       <template v-if="data.order_status >= 3">
            <li class="orter-time-item"><span class="name">发货时间</span><span class="numer">{{data.deliver_time}}</span></li>
       </template>
       <template v-if="data.order_status >= 4">
            <li class="orter-time-item"><span class="name">成交时间</span><span class="numer">{{data.finish_time}}</span></li>
       </template>
    </ul>
